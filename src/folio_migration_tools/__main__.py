...
def parse_args(args):
    ...
    parser.add_argument(
        "--batch_size",
        help=(
            "set up the batch size. defualt is 100"
        ),
        prompt="FOLIO_MIGRATION_TOOLS_BASE_BATCH_SIZE" not in environ,
        default =environ.get("FOLIO_MIGRATION_TOOLS_BASE_BATCH_SIZE", 100),
    )
...
def main():
    try:
        ...
        migration_task_config["batch_size"] = args.batch_size
